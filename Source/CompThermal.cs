...
namespace Celsius
{
    public class CompThermal : ThingComp
    {
        ...
        public override void Initialize(CompProperties props)
        {
            ...
            IsOpen |= (parent is Building_Door door && door.Open) || (parent is Building_Vent && parent.GetComp<CompFlickable>()?.SwitchIsOn == true || (parent.GetType().FullName == "OpenTheWindows.Building_Window" && parent.def.defName.Contains("Rustic"))); //HSK Custom
        }
